...
Provider = Literal[
    "vllm", "ollama", "gemini", "claude",
    # OpenAI-compatible providers/gateways used as failover targets
    # (app/providers/openai_compat.py, app/llm_router.py).
    "openrouter", "groq", "cerebras", "github", "qwen", "deepseek", "xai", "gateway",
]
...
# "system" = generated by the paper-trading engine itself (app/paper_cycle.py),
# not by an LLM provider -- so the admin Reports page can list both kinds.
NarrativeProvider = Literal[
    "vllm", "ollama", "gemini", "claude", "openrouter", "groq", "cerebras", "github", "qwen", "deepseek", "xai", "gateway", "system"
]
...
class DailyReportNarrative(BaseModel):
    ...
    profile: Optional[str] = None  # paper-trading account id, for engine-written reports
